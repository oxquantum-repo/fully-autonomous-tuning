...
class BaselAWG5208(AWG5208): 
    ...
    def make_SEQX_from_forged_sequence(
        ...
        for pos1 in seq.keys():
            if seq[pos1]['type'] == 'subsequence':
                ...
                subseqsml = BaselAWG5208._makeSMLFile(trig_waits=seqing['twait'],
                                                   nreps=seqing['nrep'],
        ...
        mainseqname = seqname
        mainseqsml = BaselAWG5208._makeSMLFile(trig_waits=seqing['twait'],
                                            nreps=seqing['nrep'],
                                            event_jumps=seqing['jump_input'],
                                            event_jump_to=seqing['jump_target'],
                                            go_to=seqing['goto'],
        ...
        user_file = b''
        setup_file = BaselAWG5208._makeSetupFile(mainseqname)
    ...
    def makeSEQXFile(trig_waits: Sequence[int],
        ...
        sml_file = BaselAWG5208._makeSMLFile(trig_waits, nreps,
        ...
        user_file = b''
        setup_file = BaselAWG5208._makeSetupFile(seqname)
    ...
    def _makeSMLFile(trig_waits: Sequence[int],
        ...
        temp_elem.text = BaselAWG5208.JUMP_TIMING  # TODO: What does this control? THIS CONTROLS THE JUMP TIMING!
