...
if __name__ == "__main__":
    ...
    if check_data_exists_on_file(data_directory_path, crops_filename, crop_labels_filename, guids_list_filename):
        ...
        make_crops_and_labels_and_guids_files(data_directory_path, labelled_data_dict_filename, crops_filename, crop_labels_filename, guids_list_filename)
